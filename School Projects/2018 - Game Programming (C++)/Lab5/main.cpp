/*
    ...
    Description:
        ...
        the borders of the screen. Allows the user to
        change the sprites movement direction using the
        arrow keys. Does this until the window is closed
